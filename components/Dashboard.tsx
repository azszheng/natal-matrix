            ...
            {section === 'vibrational' && (
              <>
                ...
                <p style={{ margin: '0 2px 10px', fontSize: 15, color: 'var(--fg-muted)', fontFamily: 'var(--font-sans)', lineHeight: 1.65, maxWidth: 640 }}>
                  This section focuses on the eleven frequencies the researcher David Cochrane&apos;s own work identifies as especially significant: the 5th (creativity &amp; play), 7th (introversion, focus &amp; skill), 8th (self-motivation &amp; central life themes), 9th (community &amp; healing), 11th (instability &amp; constant change), 13th (the drive to rise above), 17th (empathy), 19th (production &amp; creation), 23rd &amp; 29th (non-linearity — holding many perspectives at once), and 31st (personal transformation). People use this technique to surface innate talents and drives that a standard reading can miss entirely — someone with no obvious creative emphasis elsewhere in their chart may still carry an exceptionally tight 5th-harmonic conjunction pointing to a real, specific creative gift.
                </p>
                <p style={{ margin: '0 2px 14px', fontSize: 15, color: 'var(--fg-muted)', fontFamily: 'var(--font-sans)', lineHeight: 1.65, maxWidth: 640 }}>
